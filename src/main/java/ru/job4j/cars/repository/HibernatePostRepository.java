...
public class HibernatePostRepository implements PostRepository {
    private static final String FIND_BY_LAST_DAY = "FROM Post p JOIN FETCH p.car "
            + "JOIN FETCH p.car.engine JOIN FETCH p.car.body JOIN FETCH p.car.transmission "
            + "JOIN FETCH p.file WHERE p.created BETWEEN :fCreatedBefore AND :fCreatedAfter";
    private static final String FIND_BY_PHOTO = "FROM Post p JOIN FETCH p.car"
            + " JOIN FETCH p.car.engine JOIN FETCH p.car.body JOIN FETCH p.car.transmission"
            + " JOIN FETCH p.file WHERE p.file.id != 10";
    private static final String FIND_BY_MODEL = "FROM Post p JOIN FETCH p.car"
            + " JOIN FETCH p.car.engine JOIN FETCH p.car.body JOIN FETCH p.car.transmission"
            + " JOIN FETCH p.file WHERE p.car.name = :fName";
    private static final String FIND_ALL = "FROM Post p JOIN FETCH p.car"
            + " JOIN FETCH p.car.engine JOIN FETCH p.car.body JOIN FETCH p.car.transmission"
            + " JOIN FETCH p.file";
    private static final String FIND_BY_ID = "FROM Post p JOIN FETCH p.car"
            + " JOIN FETCH p.car.engine JOIN FETCH p.car.body JOIN FETCH p.car.transmission"
            + " JOIN FETCH p.file WHERE p.id = :fId";
    private static final String DELETE = "DELETE FROM Post p JOIN FETCH p.car"
            + " WHERE p.id = :fId";
    private static final String FIND_BY_SOLD = "FROM Post p JOIN FETCH p.car"
            + " JOIN FETCH p.car.engine JOIN FETCH p.car.body JOIN FETCH p.car.transmission"
            + " JOIN FETCH p.file WHERE p.sold = :fSold";
    private static final String SET_SOLD = "FROM Post p JOIN FETCH p.car"
            + " SET p.sold = :fSold WHERE p.id = :fId";
    private static final String SET_UNSOLD = "UPDATE Post p JOIN FETCH p.car"
            + " SET p.sold = :fSold WHERE p.id = :fId";
